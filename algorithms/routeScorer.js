export default class CalculateRoute {
    ...
    computeCurvature(polylinePoints) {
        const curvatures = [];
    ...
    curvatures = computeCurvature(polylinePoints);

    isRoadFun(curvatures, thresholdAngle = 30, minFunPercent = 0.5) {
